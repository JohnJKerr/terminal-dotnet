...
public sealed class WhenListingPanelShortcuts
{
    ...
    public void It_only_offers_file_actions_for_a_selected_file()
    {
        ...
        // Assert
        Assert.Equal(
            ["Tab pane", "s search", "↑/k up", "↓/j down", "Enter/e edit", "p preview", "^R rebuild", "? commands", "q quit"],
            shortcuts);
    }
    ...
    public void It_offers_folding_for_a_selected_file_group()
    {
        ...
        // Assert
        Assert.Equal(
            ["Tab pane", "s search", "↑/k up", "↓/j down", "Space/Enter fold", "z fold all", "^R rebuild", "? commands", "q quit"],
            shortcuts);
    }
    ...
    public void It_offers_diff_edit_and_preview_for_a_changed_file()
    {
        ...
        // Assert
        Assert.Equal(
            ["Tab pane", "s search", "↑/k up", "↓/j down", "Enter/d diff", "e edit", "p preview", "^R rebuild", "? commands", "q quit"],
            shortcuts);
    }
    ...
    public void It_offers_restore_instead_of_editing_for_a_deleted_file()
    {
        ...
        // Assert
        Assert.Equal(
            ["Tab pane", "s search", "↑/k up", "↓/j down", "Enter/d diff", "r restore", "^R rebuild", "? commands", "q quit"],
            shortcuts);
    }
    ...
    public void It_offers_the_comment_actions_for_a_commented_file()
    {
        ...
        // Assert
        Assert.Equal(
            ["Tab pane", "s search", "↑/k up", "↓/j down", "Enter/v view", "e edit", "p preview", "d delete", "y copy", "w save", "x clear all", "^R rebuild", "? commands", "q quit"],
            shortcuts);
    }
    ...
    public void It_offers_no_comment_actions_before_anything_is_commented()
    {
        ...
        // Assert
        Assert.Equal(["Tab pane", "s search", "^R rebuild", "? commands", "q quit"], shortcuts);
    }
